...
use Shomisha\Stubless\Concerns\HasNamespace;
use Shomisha\Stubless\Concerns\HasProperties;
...
class ClassTemplate extends DeclarativeCode
{
	...
	/** @param \Shomisha\Stubless\DeclarativeCode\ClassConstant[] $constants */
	...
	/** @return \Shomisha\Stubless\DeclarativeCode\ClassConstant[] */
